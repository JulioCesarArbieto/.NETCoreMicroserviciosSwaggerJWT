...
namespace CONTINER.API.MANAGER.Deposit
{
    public class Startup
    {
        ...
        private static void ConfigureSagger(IServiceCollection services)
        {
            ...
            {
                config.SwaggerDoc("v1", new OpenApiInfo { Title = "Continer.Api.Manager.Deposit Api", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Continer.Api.Manager.Deposit V1");
            });
            //End Swagger Configure Developer
